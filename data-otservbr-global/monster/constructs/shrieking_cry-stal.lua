...
monster.attacks = {
	...
	{ name = "energy chain", interval = 2000, chance = 20, minDamage = -749, maxDamage = -1356, range = 3, target = true },
	{ name = "combat", interval = 3000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -700, maxDamage = -1037, length = 5, spread = 2, effect = CONST_ME_SOUND_PURPLE, target = false },
